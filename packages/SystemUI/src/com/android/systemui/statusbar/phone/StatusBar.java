...
public class StatusBar extends SystemUI implements DemoMode,
    ...
    private boolean themeNeedsRefresh(){
        if (mContext.getSharedPreferences("systemui_theming", 0).getString(
                "build_fingerprint", "").equals(Build.DU_FINGERPRINT)){
            return false;
        }
        mContext.getSharedPreferences("systemui_theming", 0).edit().putString(
                "build_fingerprint", Build.DU_FINGERPRINT).commit();
        return true;
    }
        ...
        public void pulseWhileDozing(@NonNull PulseCallback callback, int reason) {
            ...
            mDozeScrimController.pulse(new PulseCallback() {
                ...
                public void onPulseStarted() {
                    ...
                    if (mHeadsUpManager.hasHeadsUpNotifications() && reason !=
                            DozeLog.PULSE_REASON_FORCED_MEDIA_NOTIFICATION) {
